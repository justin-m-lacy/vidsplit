...
import Settings from './panes/Settings.vue';
...
<template>
  ...
  cursor-auto select-none duration-200 bg-light-50 mb-1 p-0">
    <div v-if="!state.electron"
    ...
    <Media class="shrink grow max-h-10/12 h-10/12 min-w-1/2 mb-2"
